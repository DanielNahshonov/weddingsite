...
const translations = {
  ...
  he: {
    ...
    introGuestLine: (guestName: string) =>
      `נשמח לראות אתכם, ${guestName}, ביום החשוב הזה בחיינו.`,
    ...
    scheduleHighlights: [
      {
        ...
        description:
          "נשבע ונרים יחד כוסית. נשמח לראות אתכם שם לצידנו.",
      },
      {
        icon: "🎉",
        title: "המסיבה",
    ...
    countdownTitle: "מתרגשים לראות אתכם בעוד",
    countdownUnits: ["ימים", "שעות", "דקות", "שניות"],
    countdownComplete: "היום זה קורה!",
    timelineTitle: "תוכנית הערב",
    timelineIntro: "נשמח לראות אתכם ברגעים האלה.",
    locationTitle: "איפה חוגגים",
    locationIntro: "נשמח לראות אתכם באולם שלנו. כאן כל הפרטים והקישורים.",
